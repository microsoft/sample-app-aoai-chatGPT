...
|UI_TITLE|Ensono| Chat title (left-top) and page title (HTML)
|UI_LOGO|| Logo (left-top). Defaults to Ensono logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|| Logo (chat window). Defaults to Ensono logo. Configure the URL to your logo image to modify.
...
|UI_FAVICON|| Defaults to Ensono favicon. Configure the URL to your favicon to modify.
