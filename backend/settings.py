...
class _UiSettings(BaseSettings):
    ...
    citations_expanded: bool = True
    citations_as_links: bool = True
...
class _AuthSharepointSettings(BaseSettings):
    model_config = SettingsConfigDict(
        env_prefix="AUTH_SHAREPOINT_",
        env_file=DOTENV_PATH,
        extra="ignore",
        env_ignore_empty=True
    )
...
class _AppSettings(BaseModel):
    ...
    auth_sharepoint: _AuthSharepointSettings = _AuthSharepointSettings()
