...
def get_msdefender_user_json(authenticated_user_details, request_headers, application_name, end_user_tenant_id) -> UserSecurityContext:
    ...
    return UserSecurityContext(end_user_id=end_user_id, source_ip=source_ip, application_name=application_name, end_user_tenant_id=end_user_tenant_id)
