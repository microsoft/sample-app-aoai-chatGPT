...
Azureではgptモデルを変更してデバッグするのは手間がかかるので、Difyを使いました。Difyの環境は、PCにDocker Composeでデプロイしています。事例の26ファイルをナレッジとしてアップロードし、バイブリッド検索のリランクモデルはcohereのrerank-multilingual-v3.0を利用、top-kは３です。<br>
