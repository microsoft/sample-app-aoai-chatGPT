...
|[LLMのモデルの違いによる影響](./research_LLM_model.md)|LLM|gpt-4o<br>gpt-4o-mini<br>gpt-4<br>gpt-3.5-turbo|2|gpt-4oが詳細に回答する|詳細な回答が必要ならgpt-4o<br>簡易な回答でもよければgpt-4o-miniだと低コスト|
|LLMのパラメーターの影響|LLM|||||
