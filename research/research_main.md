...
|--:|:-------|:--|:--|:-----------|
|1|Neuronの導入事例を探してください|回答する事例の数を確認|5社~7社の事例を回答|26社の事例を結果表示|
|2|SharePointを検索対象にした導入事例を探してください|2社の事例を回答するか確認|2社の事例を回答|2社の事例を結果表示|
|3|SPOを検索対象にした導入事例を探してください|「SPO」を「SharePoint Online」として回答できるか確認（あいまい検索）|2社の事例を回答|類義語検索で2社の事例を結果表示|
