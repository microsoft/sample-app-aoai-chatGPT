...
|:-------------------------------------------|:--------|:-------------------------------------------------|:-----------|:-------------------------------------------------------------------------------|:---------------------------------------------------------------------------|
| [チャンキングの影響](./research_chunk.md)                                  |前処理<br>(チャンク設定)| 1,4,10                                                 |　一般的な傾向と合致する傾向が見られた。（長いチャンクは文脈保持に優れ、多くの事例や背景を含みやすい。一方、短いチャンクは情報の粒度が細かくなる傾向がある。オーバーラップを多く取ることで、文脈の連続性が高まり、情報の断絶を防げる。 ）           |                                                                                |                                                                            |
