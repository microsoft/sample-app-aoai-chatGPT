...
def check_if_search_service_exists(search_service_name: str,
    ...
    url = (
        ...
        f"/{search_service_name}?api-version=2024-05-01-preview"
    )
...
def create_or_update_search_index(
    ...
    url = f"https://{service_name}.search.windows.net/indexes/{index_name}?api-version=2024-05-01-preview"
    headers = {
        "Content-Type": "application/json",
        "api-key": admin_key,
    }
...
if __name__ == "__main__": 
    ...
    parser.add_argument("--embedding-model-endpoint", type=str, help="Endpoint for the embedding model to use for vector search. Format: 'https://<AOAI resource name>.openai.azure.com/openai/deployments/<Ada deployment name>/embeddings?api-version=2024-05-01-preview'")
