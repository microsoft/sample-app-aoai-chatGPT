...
export const QuestionInput = ({ onSend, disabled, placeholder, clearOnSend, conversationId, isGenerating, stopGenerating }: Props) => {
    ...
    (
      <Stack
        ...
        <div
          ...
          {isGenerating ? (
            <RiStopCircleLine onClick={stopGenerating} className={styles.questionInputSendButton} aria-label="Stop Generating" />
