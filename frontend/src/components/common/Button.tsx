...
interface GraphSearchDebugButtonProps extends IButtonProps {
  onClick: () => void;
}

export const GraphSearchDebugButton: React.FC<GraphSearchDebugButtonProps> = ({onClick}) => {
  const graphSearchDebugButtonStyles: ICommandBarStyles & IButtonStyles = {
      root: {
        width: 86,
        height: 32,
        borderRadius: 4,
