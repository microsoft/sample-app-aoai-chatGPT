                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start chatting with me!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>I was built to help you with HR Policies questions</h2>
                            </Stack>
                        ) : (
