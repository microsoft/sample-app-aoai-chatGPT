                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This is a safe, apetito-internal
                                    environment. You may enter personal or confidential information in your prompts, but
                                    you must still check the responses for plausibility/credibility and copyright
                                    infringements before using them. In case of doubt, please contact your line manager,
                                    data protection officer or the legal department.
                                </h2>
                                <h2 className={styles.chatEmptyStateSubtitle}>You can ask in any language you like :-)</h2>
                            </Stack>
                        ) : (
