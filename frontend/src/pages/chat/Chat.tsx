...
import AiCoreCloud from '../../assets/images/aicore_cloud.png'
      ...
      {showAuthMessage ? (
        ...
        <Stack horizontal className={styles.chatRoot}>
          <div
            ...
            style={{
              backgroundImage: `url(${AiCoreCloud})`
            }}>
            {/* <div className={styles.backgroundContainer}>
              <img className={styles.backgroundImage} src={AiCoreCloud} alt="AI Core Cloud" />
              <div className={styles.backgroundImageForeground}></div>
            </div> */}
