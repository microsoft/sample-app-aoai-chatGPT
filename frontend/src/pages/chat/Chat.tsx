                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Commencez la conversation</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Vous êtes dans l'environnement ChatGPT de RATP Smart Systems</h2>
                            </Stack>
                        ) : (
