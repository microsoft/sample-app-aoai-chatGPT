...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const question = queryParams.get("initialQuestion");
    if (question) {
      // clear chat
      clearChat();
      // send off a first chat message with the queryParams string.
  ...
  // TTD - We are not using this fn. Use the one without CosmosDB above
  ...
  return (
    <div className={`background-image ${styles.container}`} role="main">
      {showAuthMessage ? (
        ...
        <Stack horizontal className={styles.chatRoot}>
                      <div className={styles.chatContainer}>
                          ...
                          {!messages || messages.length < 1 ? (
                              ...
                              <Stack className={styles.chatEmptyState}>
                  <div className={styles.chatEmptyStateMessageContainer}>
                <img
                  ...
                  <CommandBarButton
                    ...
                    styles={{
                      ...
                      root: {
                        color: "#FFFFFF",
                        background:
                          "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #306d34 33.63%, #44984A 70.31%, #55b95c 100%)",
                      },
                      rootDisabled: {
                        background: "#F0F0F0",
                      },
