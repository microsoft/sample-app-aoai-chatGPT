          ...
          <div className={styles.chatContainer}>
            {!messages || messages.length < 1 ? (
              <Stack className={styles.chatEmptyState}>
                ...
                <h1 className={styles.chatEmptyStateTitle}>Welcome to Ask HuGo.</h1>
                <h2 className={styles.chatEmptyStateSubtitle}>
                  Ask me a question and I will try to answer as best I can using the information in the HuGo Intranet.
                </h2>
              </Stack>
            ) : (
