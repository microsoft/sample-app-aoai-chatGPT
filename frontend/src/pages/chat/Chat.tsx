                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    src={branding?.chat_logo ? branding.chat_logo : Contoso}
                                    className={styles.chatIcon}
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>{branding?.chat_title}</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>{branding?.chat_description}</h2>
                            </Stack>
                        ) : (
