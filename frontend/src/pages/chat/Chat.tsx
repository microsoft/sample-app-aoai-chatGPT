                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Hi there! ask me anything</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Bitscape Velocity-AI is designed to answer your questions</h2>
                            </Stack>
                        ) : (
