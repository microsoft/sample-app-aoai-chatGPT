                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Inizia la conversazione</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Le risposte verranno prese dai documentiPDF  forniti.</h2>
                            </Stack>
                        ) : (
